...
export default function Resources() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      setResources(arrayData(resourcesResponse));
  ...
  const createResource = async (e) => {
    ...
    try {
      ...
      setToast({
        message: res.data?.message || "Resource created successfully.",
        type: "success",
      });
  ...
  const deleteResource = async (id) => {
    ...
    try {
      ...
      setToast({
        message: res.data?.message || "Resource deleted successfully.",
        type: "success",
      });
      await loadData();
    } catch (error) {
            ...
            <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl">
              ...
              <form onSubmit={createResource} className="p-5 space-y-4">
                ...
                <div className="flex justify-end gap-2 pt-2">
                  ...
                  <button
                    disabled={saving}
                    className="px-5 py-2.5 rounded-xl bg-[#08c98b] text-white font-black text-sm flex items-center gap-2 disabled:opacity-50 hover:bg-emerald-600 transition-colors"
                  >
                    <Send size={16} />
