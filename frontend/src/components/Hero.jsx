...
function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-[720px] overflow-hidden bg-gradient-to-br from-slate-50 via-white to-teal-50 pt-32"
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-5 pb-20 lg:grid-cols-2 lg:px-8">
        ...
        <div>
          ...
          <p className="mt-7 max-w-xl text-lg leading-8 text-slate-600">
            ...
            Join ASTUMSJ Bootcamp and gain real-world skills in
            coding, technology, and problem solving. Let's build
        ...
        <div className="relative flex min-h-[450px] items-center justify-center">
          ...
          <div className="relative flex h-[330px] w-[330px] items-center justify-center rounded-full bg-white shadow-2xl shadow-[#062B67]/10">
      ...
      <div className="absolute bottom-[-80px] left-[-5%] h-40 w-[110%] rounded-[50%] bg-white" />
